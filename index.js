...
bot.on('message', async (ctx) => {
    ...
    if ((ctx.message?.new_chat_members || ctx.message?.left_chat_member)){
       ...
       await ctx.replyWithPhoto('https://bitrix.b2pos.ru/~vWZ3X', { caption: 'Здравствуйте, уважаемые коллеги! Данный чат доступен с 10:00 по московскому времени. Если вам требуется помощь, пожалуйста, обратитесь в раздел поддержки на нашей платформе, как указано на скриншоте выше. Спасибо!' });
    } else {
