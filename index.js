...
const groupChats = ['-1980493060'/*Тест на пидора*//*МТС ЗС*/]; // Замените на реальные ID групп
const groupChatsTime = ['-1980493060'/*Тест на пидора*//*МТС ЗС*/, '-1002117570128']; // Замените на реальные ID групп
